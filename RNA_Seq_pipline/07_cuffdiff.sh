output_dir=./cuffdiff
ctrl_bam=./tophat2/hela_ctrl_rep1/accepted_hits.bam,./tophat2/hela_ctrl_rep2/accepted_hits.bam
treat_bam=./tophat2/hela_treat_rep1/accepted_hits.bam,./tophat2/hela_treat_rep2/accepted_hits.bam
